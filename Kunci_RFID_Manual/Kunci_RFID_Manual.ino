...
void setup() {
  ...
  digitalWrite(relay, LOW);         // Pastikan Relay Mati
  digitalWrite(ledMerah, LED_OFF);  // Pastikan ledMerah Mati
  digitalWrite(ledHijau, LED_OFF);  // Pastikan ledHijau Mati
  digitalWrite(ledBiru, LED_OFF);   // Pastikan ledBiru Mati
  ...
  // Memeriksa jika "Master Card" sudah di daftarkan, Jika belum, maka user boleh mendaftarkan "Master Card".
  // Ini Juga Berguna untuk mendaftarkan "Master Card" Saja.
